...
if(isset($_POST['insert_user']))
{
    ...
    if($user_Name=='' or $phone=='' or $gender=='' or $email=='' or $password==''or $address=='')
    {
        ...
        // insert query to db
        $insert_user= "insert into `user_table`(user_name,phone,gender,user_email,user_password,user_address) values ('$user_Name','$phone','$gender','$email','$password','$address')";
...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-info">
    ...
    <div class="container">
      ...
      <h3 class="reg">User Registration</h3>
          ...
          <button type="submit" class="submitbtn" name="insert_user">Register</button>
      </form>
  </div>
